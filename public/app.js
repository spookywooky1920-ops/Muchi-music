(() => {
  ...
  // The native apps load this same web code inside a WebView with no
  // server-side injection, so they always talk to the live API origin.
  const IS_NATIVE = !!(window.Capacitor && window.Capacitor.isNativePlatform && window.Capacitor.isNativePlatform());
  if (IS_NATIVE && !window.MUCHI_API_BASE) {
    window.MUCHI_API_BASE = "https://muchi-music.onrender.com";
  }
