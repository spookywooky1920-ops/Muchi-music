...
4. Actions → **Build Muchi APK** → Run workflow.
5. Install the APK from the run artifact or Releases.

The APK talks to `https://muchi-music.onrender.com` unless you change `API_BASE` in `android/app/build.gradle` to your new Render URL.
